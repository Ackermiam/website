...
`)a=0,l-=r;else{const h=VE(u,s,a,l,t);a+=h.offsetX,o.push(h.path)}}return o}function VE(i,e,t,n,s){const r=s.glyphs[i]||s.glyphs["?"];if(!r){console.error('THREE.Font: character "'+i+'" does not exists in font family '+s.familyName+".");return}const o=new m0;let a,l,c,u,h,f,d,g;if(r.o){const _=r._cachedOutline||(r._cachedOutline=r.o.split(" "));for(let m=0,p=_.length;m<p;)switch(_[m++]){case"m":a=_[m++]*e+t,l=_[m++]*e+n,o.moveTo(a,l);break;case"l":a=_[m++]*e+t,l=_[m++]*e+n,o.lineTo(a,l);break;case"q":c=_[m++]*e+t,u=_[m++]*e+n,h=_[m++]*e+t,f=_[m++]*e+n,o.quadraticCurveTo(h,f,c,u);break;case"b":c=_[m++]*e+t,u=_[m++]*e+n,h=_[m++]*e+t,f=_[m++]*e+n,d=_[m++]*e+t,g=_[m++]*e+n,o.bezierCurveTo(h,f,d,g,c,u);break}}return{offsetX:r.ha*e,path:o}}class Lo extends yu{constructor(e,t={}){const n=t.font;if(n===void 0)super();else{const s=n.generateShapes(e,t.size);t.depth===void 0&&t.height!==void 0&&console.warn("THREE.TextGeometry: .height is now depreciated. Please use .depth instead"),t.depth=t.depth!==void 0?t.depth:t.height!==void 0?t.height:50,t.bevelThickness===void 0&&(t.bevelThickness=10),t.bevelSize===void 0&&(t.bevelSize=8),t.bevelEnabled===void 0&&(t.bevelEnabled=!1),super(s,t)}this.type="TextGeometry"}}const GE=Zi(!0),wl=Zi(!1),WE=Zi(0),XE=[{first:"Acker'",second:"Prod."},{first:"French",second:"Dev"},{first:"Web",second:"&3D"},{}],$o=Zi(!1),$E=new CustomEvent("nextText",{detail:"nexttext"});No($o,async(i,e)=>{console.log("test planets event")});const Aa=()=>({steps:XE,currentStep:WE,showSummary:wl,isLoading:GE,displayWorlds:$o,nextText:()=>{window.dispatchEvent($E)},handleSummary:()=>{wl.value=!wl.value},handleDisplayWorlds:()=>{$o.value=!$o.value}}),{steps:gr,currentStep:bs}=Aa();class qE{constructor(e){Re(this,"mesh");Re(this,"engine");Re(this,"textureLoader");Re(this,"loadingManager");Re(this,"animation");Re(this,"font");Re(this,"textMeshFirst");Re(this,"textMeshSecond");this.animation={smaller:!1,higher:!0,near:0,far:-12},this.engine=e,this.loadingManager=new Sa,this.textureLoader=new ba(this.loadingManager),this.loadFont()}loadFont(){new kE().load("/website/fonts/mewafont.json",t=>{this.font=t,this.createText()})}disposeText(){this.textMeshFirst.geometry.dispose(),this.textMeshSecond.geometry.dispose()}createText(){const e=this.textureLoader.load("/website/textures/4.png");e.colorSpace=yt;const t=new Bx({matcap:e}),n=new Lo(`${gr[bs.value].first}`,{font:this.font,size:this.engine.width<900?2:4,depth:.2,curveSegments:3,bevelEnabled:!0,bevelThickness:.03,bevelSize:.02,bevelOffset:0,bevelSegments:5});this.textMeshFirst=new bt(n,t),this.textMeshFirst.position.set(0,this.engine.width<900?2.2:4,-15),this.textMeshFirst.geometry.center(),this.textMeshFirst.rotation.x=-Math.PI*2.1;const s=new Lo(`${gr[bs.value].second}`,{font:this.font,size:this.engine.width<900?2:4,depth:.2,curveSegments:3,bevelEnabled:!0,bevelThickness:.03,bevelSize:.02,bevelOffset:0,bevelSegments:5});this.textMeshSecond=new bt(s,t),this.textMeshSecond.position.set(0,this.engine.width<900?-.5:0,-15),this.textMeshSecond.geometry.center(),this.textMeshSecond.rotation.x=-Math.PI*2.1;const r=new oi;r.add(this.textMeshFirst,this.textMeshSecond),r.position.y=-10,this.mesh=r,this.engine.scene.add(this.mesh)}nextStep(){const e=new Lo(`${gr[bs.value].first}`,{font:this.font,size:this.engine.width<900?2:4,depth:.2,curveSegments:3,bevelEnabled:!0,bevelThickness:.03,bevelSize:.02,bevelOffset:0,bevelSegments:5});this.textMeshFirst.geometry.dispose(),this.textMeshFirst.geometry=e,this.textMeshFirst.geometry.center();const t=new Lo(`${gr[bs.value].second}`,{font:this.font,size:this.engine.width<900?2:4,depth:.2,curveSegments:3,bevelEnabled:!0,bevelThickness:.03,bevelSize:.02,bevelOffset:0,bevelSegments:5});this.textMeshSecond.geometry.dispose(),this.textMeshSecond.geometry=t,this.textMeshSecond.geometry.center(),this.handleText()}triggerNextStep(){bs.value++,this.handleText(),bs.value<gr.length-1&&setTimeout(()=>{this.nextStep()},1e3)}handleText(){this.animation.smaller=!this.animation.smaller,this.animation.higher=!this.animation.higher}changeText(){if(this.animation.higher){const e=.98*this.mesh.position.y+.02*this.animation.near;this.mesh.position.y=e}if(this.animation.smaller){const e=.98*this.mesh.position.y+.02*this.animation.far;this.mesh.position.y=e}}tick(){this.changeText()}}const jE="/website/assets/lavatexture-ILlM-PFA.png",YE="/website/assets/lavaemissive-E5eq8yx7.png",KE="/website/assets/lavadisp-xlp0aJl-.png",JE="/website/assets/snowtexture-CFg5Yx35.png",ZE="/website/assets/snowdisp-D8Qk-fEH.png",QE="/website/assets/grasstexture-C6TcN2x0.jpg",eT="/website/assets/grassedisp-CYopUXSn.jpg";class tT{constructor(e){Re(this,"mesh");Re(this,"engine");Re(this,"textureLoader");Re(this,"lavatexture");Re(this,"lavaemissive");Re(this,"lavadisp");Re(this,"snowtexture");Re(this,"snowdisp");Re(this,"grasstexture");Re(this,"grassdisp");Re(this,"loadingManager");this.engine=e,this.loadingManager=new Sa,this.textureLoader=new ba(this.loadingManager),this.lavatexture=this.textureLoader.load(jE),this.lavatexture.colorSpace=yt,this.lavadisp=this.textureLoader.load(KE),this.lavaemissive=this.textureLoader.load(YE),this.lavatexture.wrapT=Qt,this.lavatexture.wrapS=Qt,this.lavatexture.repeat=new ce(2,2),this.snowtexture=this.textureLoader.load(JE),this.snowtexture.colorSpace=yt,this.snowdisp=this.textureLoader.load(ZE),this.snowtexture.wrapT=Qt,this.snowtexture.wrapS=Qt,this.snowtexture.repeat=new ce(2,2),this.grasstexture=this.textureLoader.load(QE),this.grasstexture.colorSpace=yt,this.grassdisp=this.textureLoader.load(eT),this.grasstexture.wrapT=Qt,this.grasstexture.wrapS=Qt,this.grasstexture.repeat=new ce(2,2);const t=new Ma(2,15,15),n=new Pr({map:this.lavatexture,displacementMap:this.lavadisp,displacementScale:.2,emissiveMap:this.lavaemissive}),s=new Pr({map:this.grasstexture,displacementMap:this.grassdisp,displacementScale:.2}),r=new Pr({map:this.snowtexture,displacementMap:this.snowdisp,displacementScale:.5,emissive:2236962}),o=new oi,a=new bt(t,r);a.position.set(0,10,-35);const l=new bt(t,n);l.position.set(-4,4,-35);const c=new bt(t,s);c.position.set(4,4,-35),o.add(a,l,c),this.mesh=o,this.mesh.position.y=-2,this.mesh.rotation.y=-.8}tick(){this.mesh.children[0].rotation.y-=this.engine.delta,this.mesh.children[1].rotation.y+=this.engine.delta,this.mesh.children[2].rotation.z+=this.engine.delta,this.mesh.rotation.y+=this.engine.delta/5}}class rs{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const nT=new Ea(-1,1,1,-1,0,1);class iT extends un{constructor(){super(),this.setAttribute("position",new Bt([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new Bt([0,2,0,0,2,0],2))}}const sT=new iT;class wa{constructor(e){this._mesh=new bt(sT,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,nT)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}}class Bc extends rs{constructor(e,t){super(),this.textureID=t!==void 0?t:"tDiffuse",e instanceof Ft?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Ks.clone(e.uniforms),this.material=new Ft({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this.fsQuad=new wa(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this.fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this.fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this.fsQuad.render(e))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}const rT={name:"RGBShiftShader",uniforms:{tDiffuse:{value:null},amount:{value:.005},angle:{value:0}},vertexShader:`
		...
		}`},oT={name:"VignetteShader",uniforms:{tDiffuse:{value:null},offset:{value:1},darkness:{value:1}},vertexShader:`
		...
		}`};class Df extends rs{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){const s=e.getContext(),r=e.state;r.buffers.color.setMask(!1),r.buffers.depth.setMask(!1),r.buffers.color.setLocked(!0),r.buffers.depth.setLocked(!0);let o,a;this.inverse?(o=0,a=1):(o=1,a=0),r.buffers.stencil.setTest(!0),r.buffers.stencil.setOp(s.REPLACE,s.REPLACE,s.REPLACE),r.buffers.stencil.setFunc(s.ALWAYS,o,4294967295),r.buffers.stencil.setClear(a),r.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),r.buffers.color.setLocked(!1),r.buffers.depth.setLocked(!1),r.buffers.color.setMask(!0),r.buffers.depth.setMask(!0),r.buffers.stencil.setLocked(!1),r.buffers.stencil.setFunc(s.EQUAL,1,4294967295),r.buffers.stencil.setOp(s.KEEP,s.KEEP,s.KEEP),r.buffers.stencil.setLocked(!0)}}class aT extends rs{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}}class lT{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){const n=e.getSize(new ce);this._width=n.width,this._height=n.height,t=new Rn(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:li}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Bc(Wp),this.copyPass.material.blending=ai,this.clock=new Fp}swapBuffers(){const e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){const t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){e===void 0&&(e=this.clock.getDelta());const t=this.renderer.getRenderTarget();let n=!1;for(let s=0,r=this.passes.length;s<r;s++){const o=this.passes[s];if(o.enabled!==!1){if(o.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(s),o.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),o.needsSwap){if(n){const a=this.renderer.getContext(),l=this.renderer.state.buffers.stencil;l.setFunc(a.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),l.setFunc(a.EQUAL,1,4294967295)}this.swapBuffers()}Df!==void 0&&(o instanceof Df?n=!0:o instanceof aT&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){const t=this.renderer.getSize(new ce);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;const n=this._width*this._pixelRatio,s=this._height*this._pixelRatio;this.renderTarget1.setSize(n,s),this.renderTarget2.setSize(n,s);for(let r=0;r<this.passes.length;r++)this.passes[r].setSize(n,s)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}class cT extends rs{constructor(e,t,n=null,s=null,r=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=s,this.clearAlpha=r,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new De}render(e,t,n){const s=e.autoClear;e.autoClear=!1;let r,o;this.overrideMaterial!==null&&(o=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(r=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(r),this.overrideMaterial!==null&&(this.scene.overrideMaterial=o),e.autoClear=s}}const uT={name:"LuminosityHighPassShader",shaderID:"luminosityHighPass",uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new De(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}er.BlurDirectionX=new ce(1,0);er.BlurDirectionY=new ce(0,1);const hT={name:"FilmShader",uniforms:{tDiffuse:{value:null},time:{value:0},intensity:{value:.5},grayscale:{value:!1}},vertexShader:`
