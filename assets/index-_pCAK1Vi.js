...
`)}function Cb(i,e){let t;switch(e){case op:t="Linear";break;case ap:t="Reinhard";break;case lp:t="Cineon";break;case cp:t="ACESFilmic";break;case hp:t="AgX";break;case up:t="Neutral";break;case ov:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Vo=new U;function Rb(){Je.getLuminanceCoefficients(Vo);const i=Vo.x.toFixed(4),e=Vo.y.toFixed(4),t=Vo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
