...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ei,depthTest:!1,depthWrite:!1})}function Xh(){return new Dt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:lu(),fragmentShader:`
		...
		`,blending:ei,depthTest:!1,depthWrite:!1})}function $h(){return new Dt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:lu(),fragmentShader:`
